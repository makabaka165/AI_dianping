...
('wf-shop-v1-summary','default','default','workflow-shop-consultant-v1','summary-llm','LLM','Shop summary','{"mode":"SHOP_COMPATIBILITY"}','{}','{"result":"agentOutput"}',120000,1,'ACTIVE','system','system'),
('wf-shop-v1-qa','default','default','workflow-shop-consultant-v1','qa-llm','LLM','Shop QA','{"mode":"SHOP_COMPATIBILITY"}','{}','{"result":"agentOutput"}',120000,1,'ACTIVE','system','system'),
('wf-shop-v1-compare','default','default','workflow-shop-consultant-v1','compare-llm','LLM','Shop compare','{"mode":"SHOP_COMPATIBILITY"}','{}','{"result":"agentOutput"}',120000,1,'ACTIVE','system','system'),
('wf-shop-v1-recommend','default','default','workflow-shop-consultant-v1','recommend-llm','LLM','Shop recommend','{"mode":"SHOP_COMPATIBILITY"}','{}','{"result":"agentOutput"}',120000,1,'ACTIVE','system','system'),
('wf-shop-v1-unknown','default','default','workflow-shop-consultant-v1','unknown-llm','LLM','Safe general answer','{"mode":"SHOP_COMPATIBILITY"}','{}','{"result":"agentOutput"}',120000,1,'ACTIVE','system','system'),
