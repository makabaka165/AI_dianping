...
public class CreateEvaluationRunRequest {@NotBlank@Size(max=64)private String datasetId;@NotBlank@Size(max=32)private String targetType;
    @Size(max=64)private String targetId;@Min(1)private Integer targetVersion;@NotEmpty@Size(max=1000)private List<@Valid EvaluationCandidateRequest>candidates=new ArrayList<>();
