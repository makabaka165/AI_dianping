...
public class IntentRuleClassifier {
    ...
    public IntentClassification classify(String input, Map<String, Object> entities) {
        ...
        if (scores.isEmpty()) {
            return new IntentClassification("UNKNOWN", Collections.emptyList(), 0.35, entities,
        ...
        return new IntentClassification(primary.intent, secondary, primary.confidence, entities,
