...
public final class MemoryRecallResult {
    ...
    public MemoryRecallResult(List<Map<String, Object>> facts, List<Map<String, Object>> episodes,
                              String conversationSummary, Map<String, Object> profile, List<String> warnings,
    ...
    public List<Map<String, Object>> getEpisodes() { return episodes; }
